...
def main():
    ...
    {dark_orange}+{'-' * 84}+{reset_color}
    \n
    {dark_red}+{'-' * 32}{reset_color}{green}{'-' * 32}+{reset_color}
    {dark_red}|{'Source Directory:'.ljust(32)}{reset_color}{green}{'Destination Directory:'.rjust(32)}|{reset_color}
    {dark_red}|{source_dir.ljust(32)}{reset_color}{green}{destination_dir.rjust(32)}|{reset_color}
    {dark_red}+{'-' * 32}{reset_color}{green}{'-' * 32}+{reset_color}
